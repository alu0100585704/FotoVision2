...
public:
    ...
    {
        BrilloYContraste->setWindowTitle(QCoreApplication::translate("BrilloYContraste", "Form", nullptr));
        lineEditBrilloGris->setText(QString());
        progressBarGrayTo0->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        pixelsLostTo255->setText(QCoreApplication::translate("BrilloYContraste", "Pixels ajustados a 255:", nullptr));
        labelContraste->setText(QCoreApplication::translate("BrilloYContraste", "<html><head/><body><p>Contraste Actual:</p></body></html>", nullptr));
        progressBarRedTo255->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        progressBarGreenTo255->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        pushButtonApply->setText(QCoreApplication::translate("BrilloYContraste", "Aplicar", nullptr));
        progressBarRedTo0->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        progressBarBlueTo255->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        pushButtonClose->setText(QCoreApplication::translate("BrilloYContraste", "Cerrar", nullptr));
        pixelsLostTo0->setText(QCoreApplication::translate("BrilloYContraste", "<html><head/><body><p align=\"center\">Pixels Ajustados a 0:</p></body></html>", nullptr));
        checkBoxKeepOriginal->setText(QCoreApplication::translate("BrilloYContraste", "Respecto a imagen original", nullptr));
        progressBarGrayTo255->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        progressBarBlueTo0->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        labelBrillo->setText(QCoreApplication::translate("BrilloYContraste", "<html><head/><body><p>Brillo Actual:</p></body></html>", nullptr));
        checkBoxRealTime->setText(QCoreApplication::translate("BrilloYContraste", "Tiempo Real", nullptr));
        progressBarGreenTo0->setFormat(QCoreApplication::translate("BrilloYContraste", "%p%", nullptr));
        labelBrilloOriginal->setText(QCoreApplication::translate("BrilloYContraste", "TextLabel", nullptr));
        labelContrasteOriginal->setText(QCoreApplication::translate("BrilloYContraste", "TextLabel", nullptr));
    } // retranslateUi
